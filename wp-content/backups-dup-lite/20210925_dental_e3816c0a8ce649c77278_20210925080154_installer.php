...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210925_dental_e3816c0a8ce649c77278_20210925080154_archive.zip';
	const ARCHIVE_SIZE		 = '54703312';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e3816c0-25080154';
    const SECONDARY_PACKAGE_HASH = 'c5715a6-25080154';
	const VERSION			 = '1.4.3';
